	...
	<div class="main">
		...
		<div class="container">
			...
			<div class="split">
				<div class="options">
					<ul>
						<li><a href="/myApp/admin/addCustomer"><i class="fa fa-user-plus" aria-hidden="true"></i> 		Add Customers</a></li>
						<li><a href="/myApp/admin/Customers"><i class="fa fa-users" aria-hidden="true"></i> 	View Customers</a></li>
						<li style="margin-left: 10px;"><a href=""><i class="fa fa-pencil" aria-hidden="true"></i> 	Edit Customer</a></li>
					</ul>
				</div>

				<div class="profile">
					<h3 style="padding-left: 30px">Edit Customers</h3>
	              <div class="form">
	              	...
	              	<form:form action="UpdateProfile" method="POST" modelAttribute="customer">
						...
						<div class="name" style="display: grid; grid-template-columns: 1fr 1fr;
	              			...
	              			<div class="companyName">
	              				<button class="button" style="background-color: red;float:left" formaction="/myApp/admin/deleteCustomer?userId=${customer.customerId }">DELETE</button><br><br>
	              			</div>
	              		</div>
